    ...
    public sealed partial class MainPage : Page
    {
        ...
        public static List<PageInfo> Pages = new List<PageInfo>
        {
            new PageInfo()
            {
                ...
                {
                    IconSource = new FluentIconSource(FluentSymbol.Home)
                },
                Title = "Home",
            ...
            new PageInfo()
            {
                ...
                Icon = new IconSourceElement()
                {
                    IconSource = new FluentIconSource(FluentSymbol.Library)
                },
                Title = "Projects",
            ...
            new PageInfo()
            {
                ...
                Icon = new IconSourceElement()
                {
                    IconSource = new FluentIconSource(FluentSymbol.Rocket)
                },
                Title = "Launch",
            ...
            new PageInfo()
            {
                ...
                Icon = new IconSourceElement()
                {
                    IconSource = new FluentIconSource(FluentSymbol.Board)
                },
                Title = "Dashboard",
