...
namespace UWPCommunityApp.Views
{
    ...
    public sealed partial class LoginView : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            LoginWrapper.NavigationStarting += LoginWrapper_NavigationStarting;
        ...
        private async void LoginWrapper_NavigationStarting(WebView sender, WebViewNavigationStartingEventArgs args)
        {
            const string redBaseUrl = "https://uwpcommunity.com/signin?authResponse=";
            const string redBaseUrl2 = "http://uwpcommunity.github.io/signin?authResponse=";
