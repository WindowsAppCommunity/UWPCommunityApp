...
namespace UWPCommunityApp.Views
{
    ...
    public sealed partial class ProjectsView : Page
    {
        ...
        private void CategoryButton_IsCheckedChanged(ToggleSplitButton sender, ToggleSplitButtonIsCheckedChangedEventArgs args)
        {
            SearchBox.Text = "";
            if (sender.IsChecked)
            {
        ...
        private void SearchByName(string query)
        {
            ...
            if (false)//CategoryButton.IsChecked)
