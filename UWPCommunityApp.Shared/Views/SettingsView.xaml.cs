...
namespace UWPCommunityApp.Views
{
    ...
    public sealed partial class SettingsView : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            ProjectCardWidth.Text = cardSize.X.ToString();
            ProjectCardHeight.Text = cardSize.Y.ToString();
        ...
        {
            ProjectCardWidth.Text = value.X.ToString();
            ProjectCardHeight.Text = value.Y.ToString();
        }
        ...
        //private void ProjectCardSize_ValueChanged(NumberBox sender, NumberBoxValueChangedEventArgs args)
        //{
        ...
        private void ProjectCardSize_ValueChanged(object sender, TextChangedEventArgs e)
        {
            var width = double.Parse(ProjectCardWidth.Text);
            var height = double.Parse(ProjectCardHeight.Text);
            SettingsManager.SetProjectCardSize(new Point(width, height));
        }
    }
}
